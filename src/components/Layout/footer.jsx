      ...
      <Row>
        ...
        <Col md={4} className="mb-4 pt-3">
          ...
          <ul className="list-unstyled text-white">
            <li>
              <a  className='text-white' target="_blank"  rel="noreferrer"  href="https://www.facebook.com">
                <FaFacebook /> Facebook
              </a>
            </li>
            <li>
              <a  className='text-white'  target="_blank" rel="noreferrer"  href="https://www.twitter.com">
                <FaTwitter /> Twitter
              </a>
            </li>
            <li>
              <a  className='text-white' target="_blank" rel="noreferrer" href="https://www.instagram.com">
